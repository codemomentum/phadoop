(ns phadoop-ui.view.auth
  (:require [ring.util.response :as response]
            [compojure.core :refer [defroutes GET POST]]
            [stencil.core :as stencil]
            [phadoop-ui.util.session :as session]
            [phadoop-ui.view.common :refer [wrap-context-root get-context-root wrap-layout]]))
...
(defn- login-page-body [request]
  (stencil/render-file
   "phadoop_ui/view/templates/auth"
